...
function ViewMoreDetailsDialog({
  ...
  // Safe "array to string" function that handles non-array values
  const arrayToString = (arr: any) => {
    // Check if arr is an array and not null/undefined
  ...
  const isCreatorOfEvent = userId === event.createdByUserId
